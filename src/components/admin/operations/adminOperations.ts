...
export const ADMIN_OPERATIONS: readonly AdminOperationDefinition[] = [
  ...
  { id: 'event-review', label: 'Revue événements', href: '/admin/revue-evenements', group: 'pilotage', icon: 'target', availability: 'available', description: 'Revue unifiée des candidats, preuves et événements du contrat v2.' },
